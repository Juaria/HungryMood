...
/*    TextInputLayout Fname,Lname,Email,Pass,CPass,MobileNo,Address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pass = (TextInputLayout)findViewById(R.id.Pswd);
        CPass = (TextInputLayout)findViewById(R.id.Cpswd);
        MobileNo = (TextInputLayout)findViewById(R.id.mobile_no);
        Address = (TextInputLayout)findViewById(R.id.CustAdd);

        Register = (Button)findViewById(R.id.CustReg);
        EmailBtn = (Button)findViewById(R.id.custmail);
        Phone = (Button)findViewById(R.id.custphone);
