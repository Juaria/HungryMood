...
import com.example.hungrymood.R;
...
public class chef_postDish extends AppCompatActivity {
    ...
    String ChefId , RandomUID , Address;
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("FoodDetails").child(Address).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID)
