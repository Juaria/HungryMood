...
public class ChefLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            email = (TextInputLayout)findViewById(R.id.LCemail);
            pass = (TextInputLayout)findViewById(R.id.LCpassword);
            Login = (Button)findViewById(R.id.Logbtn);
            CreateAcc = (TextView) findViewById(R.id.craateaccount);
            Forgotpassword = (TextView)findViewById(R.id.forgotpwd);
            Loginphone = (Button)findViewById(R.id.phonebtn);
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(task.isSuccessful()){
                                    ...
                                    if(Fauth.getCurrentUser().isEmailVerified()){
                                        mDialog.dismiss();
                                        Toast.makeText(ChefLogin.this, "You Have Successfully Logged in", Toast.LENGTH_SHORT).show();
